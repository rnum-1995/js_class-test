...
function renderTable(list = employees) {
  ...
  // TODO: list配下の社員データをループし、tr要素を作成してlistBodyに追加してください
  // trの中身は以下のような構造にしてください
  // <td>ID</td>
  // <td>氏名 (姓 + 名)</td>
  // <td>部署</td>
  // <td>年齢 (calculateAgeを利用)</td>
  // <td><button onclick="showDetail(各社員ID)" ...>詳細</button></td>

  // ヒント: document.createElement('tr')
  // ヒント: tr.innerHTML = `...`
  // ヒント: listBody.appendChild(tr)
...
function showDetail(id) {
  // TODO: 引数のidに一致する社員をemployeesから検索してください

  const dialog = document.getElementById('detail-modal');

  // TODO: 画像設定(画像が無い社員にはdefault.pngを設定)

  // TODO: 年齢計算 (calculateAge), 給与計算 (calculateTotalSalary) を行ってください

  // TODO: モーダルの各要素 (#modal-id, #modal-name 等) に値をセットしてください

  // TODO: 資格リスト (#modal-licenses) を生成して表示してください

  // TODO: モーダルを表示してください (dialog.showModal())
}
