...
### C. 提出方式
*   フォルダ名を「20260204_出席番号(半角数字ゼロ埋め2桁)_苗字(半角英字)」として提出すること。(例: 20260204_00_fukumoto)
*   提出フォルダ内に配布ファイル以外のものを含まないこと。

### D. 注意事項
*   テキスト、授業中に作成した課題、インターネット上の情報は閲覧可。
*   生成AI(ChatGPT、Gemini、Copilot等)を使ってコードを生成することは禁止。
*   授業時間中に周囲と相談することは禁止だが、休憩時間はその限りではない。